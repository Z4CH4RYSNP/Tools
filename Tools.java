 ...
 * </div>
 *
 * @author Zachary Sousa, Nathan Braniff
 * @version 1.12
 */
public class Tools {
     ...
     * @author Dave Slemon
     * @author Zachary Sousa
     * @version 1.01 (modified to use floats -ZS)
     */
     ...
     * @version 1.00
     */
    public static void bubbleSort(double[] A, int n) { //bubble
     ...
     * @return A of doubles sorted in ascending order
     * @author Dave Slemon
     * @author Nathan Braniff - Updated to use integer arrays
     * @version 1.00
     */
     ...
     * @version 1.01
     */
    public static double getMedian(int[] array, int n) {
        Tools t = new Tools();
